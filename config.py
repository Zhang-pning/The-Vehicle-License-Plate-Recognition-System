class Config:
    ...
    MYSQL_PASSWORD = 'Zhangkun*0914'  #mysql登录密码
    ...
    MAIL_USERNAME = 'plate_recognition@foxmail.com'  # 发送验证码邮件的QQ邮箱（不需要动）
    MAIL_PASSWORD = 'jsfyimcavpsldbhg'  # 发送验证码邮件的QQ邮箱的SMTP授权码（不需要动）
